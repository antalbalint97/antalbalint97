...
<p align="center">
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=500&size=22&pause=1000&color=58A6FF&center=true&vCenter=true&width=600&lines=Turning+raw+data+into+real+products;Building+ML+pipelines+end-to-end;SaaS+founder+%40+Vektr;Always+learning%2C+always+shipping" alt="Typing SVG" />
  </a>
</p>
...
I'm a Data Scientist at **Dunnhumby** working in the retail industry, and a solo founder building **Vektr** — a B2B lead scoring SaaS powered by ML. I enjoy the full journey from raw data to production-ready systems, and I'm always leveling up on the engineering side of things.

- 🏢 **Day job**: Data Scientist @ Dunnhumby (retail analytics)
- 🚀 **Side project**: Building [Vektr](https://github.com/antalbalint97) — a multi-tenant B2B lead scoring platform (GCP, Node.js, k-NN)
- 📍 Based in **Hungary**
...
|---|---|---|
| 🏢 **[Vektr](https://github.com/antalbalint97)** | Multi-tenant B2B lead scoring SaaS — enriches, scores, and ranks leads automatically | GCP, Node.js, k-NN, Pub/Sub |
